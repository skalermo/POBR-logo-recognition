...
pub fn _horizontal_line(image: &Mat, y: i32, x_start: i32, x_end: i32) -> Result<Mat, Error> {
...
pub fn _vertical_line(image: &Mat, x: i32, y_start: i32, y_end: i32) -> Result<Mat, Error> {
